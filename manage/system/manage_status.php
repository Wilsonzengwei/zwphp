                    ...
                    <div class="items_con">
                    	<span class="ciritems">
                        	...
                        	<div class="cir cirblue">
                            	<span class="cirblue"><?=$db->get_row_count('member',"IsSupplier='0'")?></span>
                                <font>用户</font>
                            </div>
                    	...
                    	<span class="ciritems">
                        	...
                        	<div class="cir cirred">
                                <span class="cirred"><?=$db->get_row_count('product','1')?></span>
                                <font>产品</font>
                            </div>
                    	...
                    	<span class="ciritems">
                        	...
                        	<div class="cir cirgreen">
                                <span class="cirgreen"><?=$db->get_row_count('member',"IsSupplier='1'")?></span>
                                <font>商家</font>
                            </div>
                            <div class="name">商家总数</div>
                        </span>
                        ...
                        <span class="ciritems">
                        	...
                        	<?php 
                        		$price_row = $db->get_all('orders',"OrderStatus='8'","TotalPrice");
                        		$arr_Price = array();
			                    if($price_row){
				                    foreach ($price_row as $key => $value) {
				                        foreach ($value as $key_1 =>$value_1) {
				                            $arr_TotalPrice[] =$value_1;
				                            
				                        }
				                    }
				                
			                    $total_price_member = array_sum($arr_TotalPrice);
			                	}
                        	?>
                            	<span class="ciryellow"><?php if($price_row){?><?=$total_price_member?><?php }else{?>0<?php }?></span>
                            	<font>美元</font>
                            </div>
                    	...
                    	<span class="ciritems">
							<iframe class="circle_frame" src="/manage/images/circle_orange.svg"></iframe>
                        	<div class="cir ciryellow">
                            	<span class="ciryellow"><?=$db->get_row_count('userinfo','1')?></span>
                            	<font>帐号</font>
                            </div>
                            <div class="name">后台帐号</div>
                        </span>
