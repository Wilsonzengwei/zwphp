...
?>
<div class="header"><?=get_lang('ly200.current_location');?>:<a href="order_count.php"><?=get_lang('count.order_count');?></a></div>
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="bat_form">
	<tr>
		<td height="22" class="flh_150">
			<form method="get" name="order_view_form" action="order_count.php" onsubmit="this.submit.disabled=true;">
...
<table width="100%" border="0" cellpadding="0" cellspacing="1">
	<tr>
		<td>
			...
			sowyd.addVariable('settings_file', escape('settings/order_count.php?<?=$service_time;?>'));
			sowyd.addVariable('data_file', escape('data/order_count.php?<?=query_string().'&t='.$service_time;?>'));
			sowyd.addVariable('preloader_color', '#000000');
			sowyd.write('order_count_data');
			</script>
		</td>
	</tr>
</table>
