...
$count_rs=$db->query("select FROM_UNIXTIME(OrderTime, '{$count_type_ary[$CountType]}') as OrderDate, sum((1-Discount)*TotalPrice) as TotalPrice from orders where $where group by OrderDate");
$data_ary=array();
