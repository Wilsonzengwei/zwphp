        ...
        <div class="float_right">
            ...
            <?php if($page){ ?>
                <?php /*?><div class="topbutton fr">
                    <?php if(get_cfg('instance.del')){?><a href="javascript:void(0);"  class="del" title="<?=get_lang('ly200.del');?>"></a><?php }?>
                </div><?php */?>
                <div class="topbutton fr">
                    <?php if(get_cfg('instance.add')){?><a href="add.php"  class="add" title="<?=get_lang('ly200.add');?>"></a><?php }?>
                </div>
            <?php } ?>
            <div class="clear"></div>
        </div>
