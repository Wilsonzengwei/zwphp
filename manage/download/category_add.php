            ...
            <div class="tr">
                ...
                <?php for($i=0; $i<count(get_cfg('ly200.lang_array')); $i++){?>
                    <div class="form_row">
                        ...
                        <span class="fl">
                            <input name="Category<?=lang_name($i, 1);?>" value="" class="form_input" type="text" size="98" maxlength="40" check="<?=get_lang('ly200.filled_out').get_lang('ly200.category_name');?>!~*" <?=get_cfg('download.category.mod_name')?'':'disabled';?>>
                        </span>
                        <div class="clear"></div>
                    </div>
                <?php } ?>  
			...
			<?php if(get_cfg('download.category.dept')>1){ ?>
                <div class="tr">
                	<div class="form_row">
                        ...
                        <span class="fl">
							<?=str_replace('<select','<select class="form_select"',ouput_Category_to_Select('UnderTheCateId', $db->get_value('manage_operation_log', 'Operation="download_category_add"', 'Value'), 'download_category', 'UId="0,"', 'Dept<'.get_cfg('download.category.dept'), get_lang('ly200.select')));?>
                        </span>
                        <div class="clear"></div>
                    </div>
                </div>
