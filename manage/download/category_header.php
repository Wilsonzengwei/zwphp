	<div class="header">
        ...
        <div class="float_right">
			<?php if($_SERVER['PHP_SELF']=='/manage/download/category.php'){ ?>
                <div class="topbutton fr">
                    <?php if(get_cfg('download.category.add')){?><a href="category_add.php"  class="add" title="<?=get_lang('ly200.add');?>"></a><?php }?>
                </div>
			<?php } ?>
            <div class="clear"></div>
        </div>
