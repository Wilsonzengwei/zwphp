...
$db->insert('product', array(
		...
		//'IsBestDeals'		=>	(int)$product_row['IsBestDeals'],
		...
		'Integral'	        =>	(int)$product_row['Integral'],
		...
		'LimitControl'		=>	(int)$product_row['LimitControl'],
		'Deadline'			=>	(int)$product_row['Deadline'],
		'Discount'			=>	(float)$product_row['Discount'],
		'AccTime'			=>	(int)$product_row['AccTime'],
		'PreSTime'			=>	$product_row['PreSTime'],
		'PreETime'			=>	$product_row['PreETime'],
		'ItemNumber2'		=>	$product_row['ItemNumber2'],
		'IsBest'			=>	$product_row['IsBest'],
	)
);
