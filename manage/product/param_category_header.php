	<div class="header">
        ...
        <div class="float_right">
			<?php if($_SERVER['PHP_SELF']=='/manage/product/param_category.php'){ ?>
                <div class="topbutton fr">
                    <?php if(get_cfg('param.category.add')){?><a href="param_category_add.php"  class="add" title="<?=get_lang('ly200.add');?>"></a><?php }?>
                </div>
			<?php } ?>
            <div class="clear"></div>
        </div>
