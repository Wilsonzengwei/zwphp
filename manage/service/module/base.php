<form style="background:#fff;min-height:600px;width:95%;overflow:hidden" action="" method="post" class="act_form" enctype="multipart/form-data">
	...
	<div class="y_form"><span class="y_title">订单号：</span><input class="y_title_txt" type="text" value="<?=$order_row['OId']?>"></div>
	...
	<div class="y_form"><span class="y_title">清关方式：</span><input class="y_title_txt" type="text" value="<?=$Clearance_one?>"></div>
	<div class="y_form"><span class="y_title">清关费用：</span><input class="y_title_txt" type="text" value="<?=$QPrice?>"></div>
	<div class="y_form"><span class="y_title">运输方式：</span><input class="y_title_txt" type="text" value="<?=$Transport_one?>"></div>
	<div class="y_form"><span class="y_title">运输费用：</span><input class="y_title_txt" type="text" value="<?=$trans_one_row['TotalPrice']?>"></div>
	<div class="y_form"><span class="y_title">运输公司：</span><input class="y_title_txt" type="text" value="<?=$shipping_row['FirmName']?>"></div>
	...
	<div class="y_form"><span class="y_title">收货地址：</span><input class="y_title_txt" type="text" value="<?=$address_row['SAddress']?>"></div>
	...
	<div style="width:100%;margin-top:20px;float:left;position:relative">
        <span style="position:absolute;top:0px" class="y_title">订单留言：</span><textarea style="width:750px;height:120px;border:1px solid #ccc;border-radius:3px;margin-left:105px" type="text"><?=htmlspecialchars($order_row['Conter'])?></textarea>
    </div>
    <div class="y_submit">
