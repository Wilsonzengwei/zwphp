<form style="background:#fff;height:60px;width:95%;line-height:40px;overflow:hidden;margin-top:20px" action="" method="post" class="act_form" enctype="multipart/form-data" onsubmit="return checkForm(this);">
...
<!-- <form style="background:#fff;min-height:110px;width:95%;overflow:hidden;margin-top:20px" action="view.php" method="post" class="act_form" enctype="multipart/form-data" onsubmit="return checkForm(this);">
    ...
    <div class="y_form3">
    	...
    	<input type="submit" value="确定" name="submit" class="ys_input">
    </div>
</form> -->	
<form style="background:#fff;min-height:110px;width:95%;overflow:hidden;margin-top:20px" action="view.php" method="post" class="act_form" enctype="multipart/form-data" onsubmit="return checkForm(this);">
    ...
    <div class="y_form3"><input type="hidden" name="OrderId" value="<?=$OrderId;?>" /><input type="hidden" name="module" value="<?=$module;?>" /><input type="submit" value="确定" name="submit" class="ys_input"></div>
</form>	
<form style="background:#fff;min-height:170px;width:95%;overflow:hidden;margin-top:20px" action="view.php" method="post" class="act_form" enctype="multipart/form-data" onsubmit="return checkForm(this);">
    ...
    <div class="y_form3"><input type="hidden" name="OrderId" value="<?=$OrderId;?>" /><input type="hidden" name="module" value="<?=$module;?>" /><input type="hidden" name="product_status_time" value="<?=time()?>"><input type="submit" value="确定" name="submit" class="ys_input"></div>
</form>	
<form style="background:#fff;min-height:50px;width:95%;overflow:hidden;margin-top:20px" action="" method="post" class="" enctype="multipart/form-data">
	...
	<div class="y_form1"><span class="y_title">运单号：</span><input class="y_title_txt_sm" type="text" name="" value="<?=$stutas_ros['TrackingNumber'];?>" readonly='true'><span class="y_title">运输公司：</span><input class="y_title_txt" type="text" name="" value="<?=$shipping_row['FirmName']?>" readonly='true'></div>
	<div class="y_form1">
...
<form style="background:#fff;min-height:50px;width:95%;overflow:hidden;margin-top:20px" action="view.php" method="post" name="" enctype="multipart/form-data" onsubmit="return checkForm(this);">
	...
	<div class="y_form1">
        ...
        <input class="form_button"  type="submit" name="freight_stutas_alter" value="修改"></td><input type="hidden" name="OrderId" value="<?=$OrderId;?>" /><input type="hidden" name="module" value="<?=$module;?>" /><input type="hidden" name="shipping_val" value="shipping_status">
