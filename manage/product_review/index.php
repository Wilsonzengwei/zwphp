...
<div class="div_con">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" id="mouse_trBgcolor_table" not_mouse_trBgcolor_tr='list_form_title'>
        ...
        <tr align="center">
            ...
            <td><a href="view.php?<?=$all_query_string;?>&RId=<?=$product_review_row[$i]['RId']?>" title="<?=get_lang('ly200.view');?>" class="mod"></a></td>
        </tr>
        <?php }?>
        ...
        <tr>
            <td colspan="20" class="bottom_act">
            	<div class="fl mgl20">
                    ...
                    <input name="product_review_del" id="product_review_del" type="button" class="list_button transition" onClick="if(!confirm('<?=get_lang('ly200.confirm_del');?>')){return false;}else{click_button(this, 'list_form', 'list_form_action');};" value="<?=get_lang('ly200.del');?>">
