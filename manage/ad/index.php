...
if($_GET['hidden_r'] == 'select_ed'){
    ...
    $where .= " and AdPosition like '%$AdPosition%'";
}
...
<form style="width:100%;background:#fff;height:60px;line-height:60px;" method="get" action="index.php">
        ...
        <input name="AdPosition" style="width:150px;height:25px;border:1px solid #ccc;border-radius:3px" type="text" value="<?=$AdPosition?>">
        ...
        <div style="background:#fff;color:#666;font-size:12px">
            <table class="haha" width="100%" border="0" cellpadding="0" cellspacing="1">
                ...
                <tr class="list" style="width:100%;height:60px;bgcolor:#fff" align="center">                   
                    ...
                    <td style="border-bottom:1px solid #e5e5e5;border-right:1px solid #e5e5e5" width="10%" ><a style="display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;width:140px;text-align:left;overflow:hidden;text-align:center"><?=$ad_row[$i]['AdPosition']?></a></td>
                    <td style="border-bottom:1px solid #e5e5e5;border-right:1px solid #e5e5e5" width="7%" ><a style="display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;width:90px;text-align:left;overflow:hidden;text-align:center"><?=$ad_row[$i]['PageName']?></a></td>
                    ...
                    <td class="operation" style="border-bottom:1px solid #e5e5e5;border-right:1px solid #e5e5e5" width="10%" >
                        <a href="mod.php?AId=<?=$ad_row[$i]['AId']?>">修改</a>
