...
<form style="background:#fff;min-height:50px;width:95%;overflow:hidden;margin-top:20px" action="" method="post" class="" enctype="multipart/form-data">
	...
	<div class="y_form1"><span class="y_title">运单号：</span><input class="y_title_txt_sm" type="text" name="" value="<?=$stutas_ros['TrackingNumber'];?>"><span class="y_title">运输公司：</span><input class="y_title_txt" type="text" name="" value="<?=$order_row['ExpressCompany']?>"></div>
	<div class="y_form1">
