...
<div id="change_weight_form" style="display:none;">
	<input type="text" name="TotalWeight" id="TotalWeightInput" onkeyup="set_number(this, 1);" onpaste="set_number(this, 1);" value="<?=$order_row['TotalWeight'];?>" size="5" maxlength="10" class="form_input" />KG&nbsp;&nbsp;&nbsp;
