			...
			<?php if(get_cfg('info.category.dept')>1){ ?>
                <div class="tr">
                	<div class="form_row">
                        ...
                        <span class="fl">
							<?=str_replace('<select','<select class="form_select"',ouput_Category_to_Select('UnderTheCateId', $db->get_value('manage_operation_log', 'Operation="info_category_add"', 'Value'), 'info_category', 'UId="0,"', 'Dept<'.get_cfg('info.category.dept'), get_lang('ly200.select')));?>
                        </span>
                        <div class="clear"></div>
                    </div>
                </div>
