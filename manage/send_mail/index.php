        ...
        <?php if($menu['member']){?>
            <td width="30%" valign="top">
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  ...
                  <tr>
                    <td height="30">
                        <input name="button" type="button" class="sm_form_button" onClick='change_all("MailList[]");' value="<?=get_lang('ly200.anti_select');?>">
                        <input name="button" type="button" class="sm_form_button" onClick='bat_add_email_address();' value="<?=get_lang('ly200.add');?>">
                    </td>
                  </tr>
                </table>
