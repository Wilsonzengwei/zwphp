...
<tr <?php echo $on_mouse;?>>
    ...
    ?>
    <td <?php echo $click_mouse;?> bgcolor="<?php echo $bgcolor;?>" nowrap>&nbsp;<label onclick="return (document.getElementById('checkbox_row_<?php echo $i;?>') ? false : true)" for="checkbox_row_<?php echo $i;?>"><?php echo $field_name;?></label>&nbsp;</td>
...
<?php echo PMA_MYSQL_INT_VERSION >= 40100 ? '    <td bgcolor="' . $bgcolor . '" ' . $click_mouse . '>' . (empty($field_charset) ? '&nbsp;' : '<dfn title="' . PMA_getCollationDescr($field_charset) . '">' . $field_charset . '</dfn>') . '</td>' . "\n" : '' ?>
    <td <?php echo $click_mouse;?> bgcolor="<?php echo $bgcolor;?>" nowrap style="font-size: <?php echo $font_smallest;?>"><?php echo $attribute;?></td>
    <td <?php echo $click_mouse;?> bgcolor="<?php echo $bgcolor;?>"><?php echo (($row['Null'] == 'YES') ? $strYes : $strNo);?>&nbsp;</td>
    <td <?php echo $click_mouse;?> bgcolor="<?php echo $bgcolor;?>" nowrap><?php if (isset($row['Default'])) echo $row['Default'];?>&nbsp;</td>
    <td <?php echo $click_mouse;?> bgcolor="<?php echo $bgcolor;?>" nowrap><?php echo $row['Extra'];?>&nbsp;</td>
    <?php
    if (!$tbl_is_view) {
        ?>
    <td align="center" bgcolor="<?php echo $bgcolor;?>">
    ...
    <?php
        if ((!empty($tbl_type) && $tbl_type == 'MYISAM')
            ...
            echo "\n";
            ?>
    <td align="center" bgcolor="<?php echo $bgcolor;?>" nowrap>
...
<tr>
    ...
    <td valign="top">
        ...
        <tr>
            ...
            <td bgcolor="<?php echo $cfg['BgcolorTwo'];?>" align="right" nowrap><?php echo $data_size;?></td>
        ...
        <tr>
            ...
            <td bgcolor="<?php echo $cfg['BgcolorTwo'];?>" align="right" nowrap><?php echo $index_size;?></td>
        ...
        <tr style="color: #bb0000">
            ...
            <td bgcolor="<?php echo $cfg['BgcolorTwo'];?>" align="right" nowrap><?php echo $free_size;?></td>
        ...
        <tr>
            ...
            <td bgcolor="<?php echo $cfg['BgcolorOne'];?>" align="right" nowrap><?php echo $effect_size;?></td>
        ...
        <tr>
            ...
            <td bgcolor="<?php echo $cfg['BgcolorOne'];?>" align="right" nowrap><?php echo $tot_size;?></td>
    ...
    <td valign="top">
        ...
        <tr>
            ...
            <td bgcolor="<?php echo $bgcolor;?>" align="<?php echo $cell_align_left;?>" nowrap>
                <?php
                echo '                ';
        ...
        <tr>
            ...
            <td bgcolor="<?php echo $bgcolor;?>" align="right" nowrap>
        ...
        <tr>
            ...
            <td<?php if($theme=='default' || $theme==''){ echo ' style="font-size:' . $font_smaller . '"'; } ?> align="right" bgcolor="<?php echo $bgcolor;?>" nowrap>
