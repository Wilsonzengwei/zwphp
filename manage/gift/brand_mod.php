...
$page_cur='gift_brand';
check_permit('gift_brand', 'gift.brand.mod');
...
if($_POST){
	...
	if(get_cfg('gift.brand.description')){
...
$BId=(int)$_GET['BId'];
$brand_row=$db->get_one('gift_brand', "BId='$BId'");
$brand_description_row=$db->get_one('gift_brand_description', "BId='$BId'");
...
<div class="div_con">
    ...
    <form method="post" name="act_form" id="act_form" class="act_form" action="brand_mod.php" enctype="multipart/form-data" onsubmit="return checkForm(this);">
    	<div class="table">
            ...
            <div class="tr">
            	<div class="tr_title"><?=get_lang('ly200.mod').get_lang('gift.brand');?></div>
