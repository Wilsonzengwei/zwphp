...
<form style="background:#fff;min-height:600px;width:95%" action="add.php" method="post" class="act_form" enctype="multipart/form-data">
    ...
    <div class="y_form"><span class="y_title">协议标题(中文)：</span><input class="y_title_txt" type="text" name="Titles_lang_1"></div>
    <div class="y_form"><span class="y_title">协议标题(英文)：</span><input class="y_title_txt" type="text" name="Titles_en"></div> 
    <div class="y_form"><span class="y_title">协议标题(西文)：</span><input class="y_title_txt" type="text" name="Titles"></div> 
        ...
        <select name="TypeManage" id="">
           <?php 
            ...
            for($i=0;$i<count($help_row);$i++){
                $inc = $i+1;
        ?>
            <option value="<?=$inc?>"><?=$help_row[$i]['Titles']?></option>
        <?php }?>
        </select></div> 
    ...
    <div class="y_form"><span class="y_title">关键词：</span><input class="y_title_txt" type="text" name="KeyWords"></div> 
    <div class="y_form"><span class="y_title">描述：</span><input class="y_title_txt" type="text" name="Description"></div> 
    ...
    <div class="editor_row" style="margin-top: 80px;color:#666;font-size:12px;    font-weight: bold;">
        ...
        <textarea style="min-height: 400px;width: 780px;" name="Content_lang_1" class="form-control content_duo"></textarea> 
        </div>
        <div class="clear"></div>
    </div>
    <div class="editor_row" style="margin-top: 80px;color:#666;font-size:12px;    font-weight: bold;">
        ...
        <div class="editor_con ck_editor fl">
        <textarea style="min-height: 400px;width: 780px;" name="Content_en" class="form-control content_duo"></textarea> 
        </div>
        <div class="clear"></div>
    </div>
    <div class="editor_row" style="margin-top: 80px;color:#666;font-size:12px;    font-weight: bold;">
        ...
        <div class="editor_con ck_editor fl">
        <textarea style="min-height: 400px;width: 780px;" name="Content" class="form-control content_duo"></textarea> 
        </div>
        <div class="clear"></div>
    </div>
    <div class="y_submit">
