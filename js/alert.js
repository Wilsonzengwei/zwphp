    window.alert=function(td){
    var alertDiv=document.createElement("div");
    alertDiv.id="alertDiv";    
    alertDiv.style.width="300px";
    alertDiv.style.height="128px";
    ...
    str+="</li>";
    str+="<li>";
    str+="<span style=\"display:inline-block;width:17%;height:27px;background:url(/images/Prompt.jpg) no-repeat;margin-top:19px;margin-left:31px\"></span>";
    str+="<span style=\"display:inline-block;background:#fff;position:absolute;top:30%;left:25%;text-align:center;line-height:40px;font-size:12px;font-weight:normal\">"+td+"</span>";
    str+="</li>";
    str+="<button style='background:#ed5758;width:53px;height:23px;border:1px solid #e14343;border-radius:5px;color:#fff;zIndex:999;position:absolute;left:30%;bottom:10%;cursor:pointer;' onclick='disappear()'>确定</button>";
