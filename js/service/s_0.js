...
function service_s_0_move(){
	if(doc.clientWidth>1000){
		$_('service_s_0').style.left=(document.documentElement.scrollLeft || window.pageXOffset || document.body.scrollLeft)+doc.clientWidth-100+'px';
		$_('service_s_0').style.top=(document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop)+150+'px';
