...
include($site_root_path.'/inc/manage/config/1.php');	//加载配置文件，0：企业网站，1：商城网站
// include($site_root_path.'/inc/manage/config/'.$_SESSION['WorkType'].'.php');	//加载配置文件，0：企业网站，1：商城网站
