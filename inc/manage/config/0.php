...
$Ly200Cfg=array(
	...
	//信息管理系统
	'article'		=>	array(
							'amdo'				=>	array('group_0','group_1'),	//允许添加，修改标题，删除，排序的分组
	...
	'product'		=>	array(
							...
							'size_ele'			=>	1,	//尺寸，从product_size表选择
							'size_ele_mode'		=>	1,	//尺寸选择模式，0：单选，1：多选
							'brand_ele'			=>	1,	//品牌，从product_brand表单选
							'stock'				=>	1,	//库存
							'start_from'		=>	1,	//起订量
							'weight'			=>	1,	//重量
							'pic_count'			=>	1,	//图片数量，0-8张，设置为0则不需上传图片
							'pic_alt'			=>	1,	//图片Alt
							'pic_size'			=>	array('350X350', 'default'=>'160X160','90X90'),	//缩略图尺寸（购物网站必须开启90*90的缩略图，根据需要开启70*70的缩略图）
	...
	'instance'		=>	array(
							...
							'is_in_index'		=>	0,	//首页显示
							'is_classic'		=>	0,	//经典案例
							'pic_count'			=>	3,	//图片数量，0-5张，设置为0则不需上传图片
							'pic_alt'			=>	0,	//图片Alt
...
$menu=array(
	...
	'instance_category'	=>	1,	//成功案例类别
	'instance'			=>	1,	//成功案例管理
	
	'download_category'	=>	1,	//下载中心类别
	'download'			=>	1,	//下载中心管理
	...
	'feedback'			=>	1,	//在线留言管理
	'product_inquire'	=>	1,	//在线询盘管理
	'newsletter'		=>	1,	//邮件列表管理
	'product_review'	=>	0,	//产品评论管理
	'gift_review'	    =>	1,	//礼品评论管理
...
$manage_menu=array(
	...
	'feedback'	=>	array(
						...
						'gift_review'	    =>	array('gift_review/index.php', 'gift_review.gift_review_manage'),
					),
	'admin'		=>	array(
