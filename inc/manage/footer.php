...
<script type="text/javascript">
	...
	//日期选择
	$('input[name=ShippingTime],.SelectDate,#SelectDate,#SelectDateS,#SelectDateE,#RegTimeS,#RegTimeE,#LastLoginTimeS,#LastLoginTimeE,#OrderTimeS,#OrderTimeE').daterangepicker({
