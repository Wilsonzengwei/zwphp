...
$Ly200Lang=array(
	'ly200'			=>	array(
							...
							'lang_array'			=>	array('lang_0'=>$website_language['ylfy'.$lang]['xwb'], 'lang_1'=>$website_language['ylfy'.$lang]['zwb'],'lang_2'=>$website_language['ylfy'.$lang]['ywb']),
							...
							'list'					=>	'列表',
							'select'				=>	'选择',
							'select1'				=>	$website_language['ylfy'.$lang]['xz'],
							'anti_select'			=>	'反选',
							'number'				=>	'序号',
							'photo'					=>	'图片',
							'time'					=>	'时间',
							...
							'contents'				=>	'详细内容',
							'description'			=>	'详细介绍',
							'description1'			=>	$website_language['ylfy'.$lang]['xxjs'],
	...
	//客户管理
	'buyers'		=>	array(
						'buyers_member_manage'=> '客户管理',
						'buyers_level_manage' => '客户等级',
		),
	...
	'member_handle'		=>	array(
						...
						'ad_member'				=>	'广告管理',
						'article_group_0'		=>	'店铺管理',
						'member_level_manage' 	=>  '商户等级',
	...
	'product'		=>	array(
							...
							'price_r'			=>	array('price_0'=>'美元价格', 'price_1'=>'人民币价格'),
							'special_offer'			=>	'特价',
							'is_promotion'			=>	'限时抢购',
							'wholesale_price'		=>	'批发价',
                            'integral'              =>  '积分',
	...
	'member'		=>	array(
							...
							'salesman'				=>	'业务员',
							'salesman_name'			=>	'名字',
							'salesman_name_nut_null'=>	'业务员名字不能为空！',
							'level'					=>	array(
															'level'			=>  '等级',
															'level_name'	=>	'级别名称',
															'price'			=>	'升级消费金额',
	...
	'orders'		=>	array(
							'status'				=>	'订单管理',
							'transport_tracking'	=>	'运输追踪',
							'group_status'			=>	'商家状态',
							'get_to'				=>	'到达',
							'un_get_to'				=>	'未到达',
							'application_for_deposit' => 	'商家申请定金',
							'arrive_warehouse'		=>	'货物是否到达公司仓库',
							'sign_for_status'		=>	'客户是否签收',
							'client_payment_status'	=>	'客户付款状态',
							'customer_signing_status'=> '客户签收状态',
							'sign'					=>	'已签收',
							'not_sign'				=>	'未签收',
							'account_paid'			=>	'已付款',
							'non_payment'			=>	'未付款',
							...
							'order_status'			=>	'订单状态',
							'order_status_1'		=>	'订单状态一览表',
							'receipt_pach'			=>	'收据照片',
							'confirm_receipt'		=>	'确认收据有效',
							'payment_method'		=>	'付款方式',
							'base_info'				=>	'基本信息',
							'address_info'			=>	'地址信息',
							'products_list'			=>	'订单追踪',
	...
	'shipping'		=>	array(
							...
							'CustomsStatus'			=>	'清关方式',
							'modelname_CustomsClearance'=>	'运输及清关费用 ',
						),
