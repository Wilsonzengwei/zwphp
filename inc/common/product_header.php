            ...
            <div class="search">
                <form action="/products.php">
                    ...
                    <select name="IsSupplier" id="" class="select">
                        ...
                        <option value="3"><?=$website_language['manage'.$lang]['eag_prod_1']; ?></option>
                    </select>
...
<script>
    ...
    $(".head_bot").click(function(){
        window.sessionStorage.removeItem("dataBorder");
    })
    $(".head_top").click(function(){
        window.sessionStorage.removeItem("dataBorder");
    })
    $(".head_mid").click(function(){
        window.sessionStorage.removeItem("dataBorder");
    })
</script>