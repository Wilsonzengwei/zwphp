...
<div id="platform_header">
    <div class="head_top">
        <div class="global">
            ...
            <div class="loginbar fr">
                 <span style="color:#E70012;cursor:pointer;" ><a href="/index.php" style="color:#E70012;"><?=$website_language['member'.$lang]['login']['eaglesell_return']?></a></span>
                ...
                <span id="language" style="height: 16px; ">
                    ...
                    <div style="width: 102px;">
                        <div style="width: 20px;height: 20px;float: left;line-height: 30px;margin-top: 6px;"><img src="/images/chinese.png"></div>
                         <div style="width: 20px;height: 20px;float: left;line-height: 30px;margin-left: 2px;margin-top: 7px;"><img src="/images/spanish.png"></div>
                    ...
                    <span class="lang_list trans3" style="top: 30px;width: 90px;">
                        <a href="javascript:;" class="list trans3 set_lang" lang="cn">
                            <div style="width: 100%;">
                                <div style="width: 20px;height: 20px;float: left;line-height: 30px;margin-left: 10px;margin-top: 5px;"><img src="/images/chinese.png"></div>
    ...
    <div class="head_mid">
        <div class="global">
            ...
            <!-- <div class="rig_con">
                <a href="/account.php?module=wishlists" class="wish"><?=$website_language['head'.$lang]['favorites']; ?></a>
                <div class="track">
                    <?=$website_language['head'.$lang]['shipping']; ?>
                    <em class="w_bor"></em>
                    <div class="content">
                        <table>
                            <tr style="height: 30px;">
                                <td style="border-bottom: 1px solid #e8edef;color: #1b4c7e;"  width="91">SPX500</td>
                                <td style="border-bottom: 1px solid #e8edef;"  width="63">2204.3</td>
                                <td style="border-bottom: 1px solid #e8edef;" >2205.15</td>
                                <td style="border-bottom: 1px solid #e8edef;" ><img src="/images/add.jpg" alt=""></td>
                            </tr>
                            <tr style="height: 30px;">
                                <td style="border-bottom: 1px solid #e8edef;color: #1b4c7e;"  width="91">SPX500</td>
                                <td style="border-bottom: 1px solid #e8edef;"  width="63">2204.3</td>
                ...
                <a href="/article.php?AId=32" class="flete"><?=$website_language['head'.$lang]['type']; ?></a>
            </div>
 -->
    ...
    <div class="head_bot">
        <div class="nav global">
            ...
            <div class="nav_list">
                ...
                <a href="/products.php?CateId=110" class="list" title="Venta al por mayor de B2B"><?=$website_language['nav'.$lang]['type_5']; ?></a>                                               
            </div>
            <div class="clear"></div>
        </div>
    </div>
