<?php
$instance_img_width=350;	///成功案例图片宽度
$instance_img_height=350;	//成功案例图片高度
$contents_width=720;	//显示内容的div的宽度

!isset($instance_row) && include($site_root_path.'/inc/lib/instance/get_detail_row.php');
...
<div id="lib_instance_detail" style="width:<?=$contents_width;?>px;">
	<div class="info">
		<div class="img" style="width:<?=$instance_img_width;?>px; height:<?=$instance_img_height;?>px;">
			<div><img src="<?=str_replace('s_', "{$instance_img_width}X{$instance_img_heigh}_", $instance_row['PicPath_0']);?>"/></div>
		</div>
