...
<div id="lib_product_detail" style="width:<?=$contents_width;?>px;">
	<div class="info">
		...
		<div class="pro_info" style="width:<?=$contents_width-$product_img_width-15;?>px;">
			...
			<!---->
				<div class="item flh_180"><?=format_text($product_row['BriefDescription']);?></div>
				<div class="item">
					<div>
						<div class="fl">市场价：<del class="fc_gory">￥<?=$product_row['Price_0'];?></del></div>
						<div class="fr">会员价：<font class="fc_red">￥<?=$product_row['Price_1'];?></font></div>
						<div class="clear"></div>
					</div>
				</div>
			<!---->
	...
	<div class="description">
		...
		<div class="desc_contents"><?=$db->get_value('product_description', "ProId='{$product_row['ProId']}'", 'Description');?></div>
	</div>
</div>
<?php
