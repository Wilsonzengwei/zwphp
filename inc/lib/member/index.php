...
$login_module_ary=array('index', 'cart', 'coll', 'orders', 'orders_date', 'address','service_info','logout','order_list','eaglehome');	//需要登录的模块列表
$un_login_module_ary=array('login', 'forgot', 'create','orders','confirm_email');	//不需要登录的模块列表
...
!in_array($module, $module_ary) && $module!='orders'  && $module=$module_ary[0];
ob_start();
...
<div id="lib_member">
	<div class="rightContents">
		<div class="member_module"><?php include($site_root_path."/inc/lib/user/module/$module.php");?></div>
	</div>
