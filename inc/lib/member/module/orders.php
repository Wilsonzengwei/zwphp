...
<div class="index_box">
	...
	<form action="">
		<input class="search_input" placeholder='请输入产品名称' style="" type="text">	
...
<div class="mask">
	...
	?>
		<div class="b1">
			...
			<div class="b3">
				<div class="he_mask"><span class='span_title'>商品名称</span><span class='he1'>：</span><div class="hhe"><?=$order_list_row[$i]['Name_lang_1']?></div>
				</div>
				<div class="he_mask"><span class='span_title'>卖家名称</span><span class='he1'>：</span><div class="hhe"><?=$SupplierIdss[$i]['Supplier_Name'];?></div>
				</div>
				<div class="he_mask"><span class='span_title'>交易金额</span><span class='he1'>：</span><div class="ca_b2">USD $<?=$TotalPrice[$i]['TotalPrice'];?></div>
				</div>
				<div class="he_mask"><span class='span_title'>购买时间</span><span class='he1'>：</span><div class="hhe"><?php //var_dump($order_rows[$i]);exit; ?><?=date("Y-m-d H:i:s",$order_rows[$i]['OrderTime']);?></div>
				</div>				
				<div class="he_mask"><span class='span_title'>订单号</span><span class='he1'>：</span><div class="hhe"><?=$OId[$i]?></div>
				</div>
			</div>		
		</div>
