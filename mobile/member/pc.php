...
<div id="customer">
	<div class="global">
		<div class="top_title">
			<a href="<?=$mobile_url.$member_url;?>?module=logout" class="close"></a>
		</div>
		<div class="content">
			<div class="supplier_tips">
				<?=$website_language['member'.$lang]['login']['tips4']; ?>
				<br />
				<a href="<?=$mobile_url.$member_url;?>?module=logout" class="return trans5"><?=$website_language['member'.$lang]['login']['return']; ?></a>
			</div>
		</div>
	</div>
</div>
