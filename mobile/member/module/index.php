	...
	<div>
		<div class="item_card">
			...
			<div class="info lib_member_item_card">
				...
				<strong><?=$website_language['member'.$lang]['other']['name']; ?>: </strong><?=$member_row['Supplier_Name']; ?><br />
				...
				<div><input type="button" value="<?=$website_language['member'.$lang]['index']['edit']; ?> >>" class="form_button" onclick="window.location='<?=$mobile_url.$member_url;?>?module=profile';" /></div>
			</div>
		</div>
